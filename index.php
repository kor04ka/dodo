...
<html lang="en">
  <head>
    ...
    <?php 
        ...
        $db_query2 = 'SELECT * FROM pizza';

        $query1 = mysqli_query($connect, $db_query2);

        $db_query1 = 'SELECT * FROM basket';

        $query2 = mysqli_query($connect, $db_query1);
    ?>
  </head>
  <body>
    <div class="col-10 mx-auto">     
        <div class="row">   <!-- header -->
            ...
            <?php while ($row2 = mysqli_fetch_assoc($query2)) {?>
                ...
                <div class="row mt-3">
                    <div class="col-3">
                        <img src="img/<?php echo $row2['image']?>" class="w-100">
                    </div>
                    <div class="col-4 mt-2">
                        <h5><?php echo $row2['name']?></h5>                        
                    </div>
                    <div class="col-2 mt-2 px-0 text-center">
                        <h5><?php echo $row2['price']?>  <span>₽</span></h5>                        
                    </div>
                    <div class="col-2 mt-2">
                        <form action="delete.php" method="GET">
                            <input style="display: none;" name="id" value="<?php echo $row2['id']?>">
        ...
        <div class="row  pb-5">
            ...
            <div class="col-3">   
                ...
                <div class="row">
                    <div class="col-6">
                        <h3><?php echo $row['price']?> <span>₽</span></h3>                        
                    </div>
                    <div class="col-6">
                        
                        <form action="basket.php" method="GET">
                            <input style="display: none;" value="<?php echo $row['name']?>" name="name">
                            <input style="display: none;" value="<?php echo $row['image']?>" name="image">
                            <input style="display: none;" value="<?php echo $row['price']?>" name="price">
                            <button class="btn bg-btn-dodo" style="position: absolute; right: 15%; bottom: 13%;">Выбрать</button>
                        </form>
